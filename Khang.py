...
\033[1;91m  ♦♦♦CONTACT FACEBOOK / TWITTER @itzMAAZOhere♦♦♦   
...
jalan("   \033[1;91m SCRIPT EDITOR ༆ᴛᴀ°᭄MAAZO ")

jalan("   \033[1;91m THIS IS ILLEGAL IM NOT RESPONSIBLE FOR THIS ")	

jalan("   \033[1;91m WIFI AND LOW SINGNAL USERZ USE ANY PROXY ")	

jalan("   \033[1;93m Welcome To ༆ᴛᴀ°᭄MAAZ0 Creations ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mAb-Maax0\033[1;96m•◈•──────────•◈•")

CorrectUsername = "ab"

CorrectPassword = "maazo"
...
def pilih_super():
	...
	print  "  \033[1;36;48m ●💋══════════════════◄JANI WAIT--KAR0►══════════════════💋●" 
...
\033[1;31;40m ●════════════════════════◄ Thanks To @itzab-maaxohere ►════════════════════════●
